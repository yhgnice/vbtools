...
class EmailVerifyrecord(models.Model):
	...
	send_type = models.CharField(verbose_name="类型", choices=(("register", u"注册"), ("forget", u"找回密码")), max_length=20)
	send_time = models.DateTimeField(verbose_name="时间", default=datetime.now)
